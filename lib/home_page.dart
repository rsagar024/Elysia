...
import 'package:elysia/feature_box.dart';
import 'package:elysia/openai_service.dart';
import 'package:elysia/pallete.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BounceInDown(child: const Text('Elysia')),
